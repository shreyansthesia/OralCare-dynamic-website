...
<html lang="en">
  <head>
    <title>Toothsy &mdash; Colorlib Website Template</title>
    <meta charset="utf-8">
    ...
    <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container">
        <div class="row align-items-center position-relative">
            ...
            <div class="site-logo">
              <a href="index.html" class="text-black"><span class="text-primary">Tooth</span>sy</a>
            </div>
            ...
            <div class="col-12">
              <nav class="site-navigation text-center " role="navigation">
                ...
                <li><a href="index.html#team-section" class="nav-link">Doctors</a></li>
          ...
          <div class="col-lg-5">
            ...
            <div class="box-shadow-content">
              <div class="block-heading-1">
                <span class="d-block mb-3"  data-aos="fade-up">March 21, 2019 <span class="mx-2">&bullet;</span> by James Miller</span>
